        ...
        <div className="flex flex-col gap-10 ">
            ...
            <div className="flex flex-col bg-[#1E1E1E] p-4 rounded-xl justify-center items-center text-gray-200 gap-2"  >
                ...
                <form className="flex flex-col gap-4  m-4 w-60">
                    <input className="bg-[#121212]  rounded-md px-4 py-2" type="text" placeholder="Nome" />
                ...
                <div>
                    <Link to={'/auth/loginPage'}>
                        <h1 className="cursor-pointer">Ja possuí uma conta?
                            <span className="underline m-2">Entrar</span>
                        </h1>
                    </Link>
                </div>
            </div>
